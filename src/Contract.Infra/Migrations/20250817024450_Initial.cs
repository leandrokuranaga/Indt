    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 4, 1, 0, 0, 0, 0, DateTimeKind.Utc), "João da Silva", 1, "Approved", "07038612042", "BRL", 149.90m },
                    { 2, new DateTime(2025, 4, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Maria Oliveira", 2, "Approved", "20791888010", "BRL", 199.50m },
                    { 3, new DateTime(2025, 4, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Carlos Pereira", 3, "Approved", "14590488060", "BRL", 99.00m },
                    { 4, new DateTime(2025, 4, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Ana Souza", 4, "Approved", "17448756001", "BRL", 250.00m },
                    { 5, new DateTime(2025, 4, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Pedro Santos", 5, "Approved", "68456412007", "BRL", 300.75m }
                });
        }
